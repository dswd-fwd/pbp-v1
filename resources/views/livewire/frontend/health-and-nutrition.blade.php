...
class extends Component {
    ...
    public function mount()
    {
        ...
        $this->user = Auth::user();
        $this->section = Section::with('questions.options.subOptions')->where('name', 'HEALTH AND NUTRITION')->first();
    ...
    public function submitAnswer()
    {
        ...
        $this->redirect(route('mental-health-and-wellbeing'), navigate: true);
...
<div class="w-full max-w-4xl p-10 m-auto overflow-hidden bg-white border border-zinc-200 text-zinc-800 rounded-xl">
    ...
    <form wire:submit="submitAnswer">
        ...
        <div class="flex justify-end gap-4 mt-8">
            <div class="w-full">
                <a wire:navigate href="{{ route('housing-water-sanitation') }}">
    ...
    <div class="flex justify-center mt-16">
        <x-form.progress-indicator :start="1" :end="10" :current="4" />
    </div>
</div>
